...
void ImGuiInit(GLFWwindow *window, bool set_colors, bool set_fonts) {
	...
	if (set_fonts)
		ImGui::GetIO().Fonts->AddFontFromFileTTF(
		    "assets/fonts/CascadiaCodeNF-Regular.ttf", 15.0f);
...
void SetImGuiColors() {
	...
	colors[ImGuiCol_Tab] = ImVec4(0.16f, 0.20f, 0.23f, 1.00f);
	colors[ImGuiCol_TabHovered] = ImVec4(0.28f, 0.56f, 1.00f, 0.80f);
	colors[ImGuiCol_TabActive] = ImVec4(0.25f, 0.30f, 0.34f, 1.00f);
	colors[ImGuiCol_TabUnfocused] = ImVec4(0.07f, 0.10f, 0.15f, 0.97f);
	colors[ImGuiCol_TabUnfocusedActive] =
	    ImVec4(0.14f, 0.22f, 0.36f, 1.00f);
